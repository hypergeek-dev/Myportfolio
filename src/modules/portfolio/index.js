...
const soloProjects = [
  ...
  { imageUrl: 'https://raw.githubusercontent.com/hypergeek-dev/Myportfolio/main/src/assets/graphic/cipher_forge.webp', description: 'I created a Python-based password generator using a modified pseudo-random formula. It adds randomly generated words from a web-scraped list to the beginning and end of each password. I also tested the passwords against a list of popular ones for added security.', repository:'https://github.com/hypergeek-dev/cipher-forge', liveSite:'https://http://dmjnow.se/' },
