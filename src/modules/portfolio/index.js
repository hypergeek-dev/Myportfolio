    ...
    <>
      <div className="container full-height">
        <div className="text-center custom-top-padding">
          <h1 className="display-4 py-2 mt-5 custom_headlines">Solo projects</h1>
        </div>
        ...
        <div className="text-center py-2 mt-4">
          <h1 className="display-4 custom_headlines">Colloquial projects</h1>
        </div>
